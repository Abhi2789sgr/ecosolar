...
if($bypass)
{
  ...
  if ($conn->query($sql) === TRUE){
    $sqlLatest = "INSERT INTO `_g_data_latest` (`device`, `v1`, `v2`, `v3`, `v4`, `v5`, `v6`, `v7`, `v8`, `v9`, `v10`, `v11`, `v12`, `v13`, `v14`, `v15`, `v16`, `v17`, `v18`, `v19`, `v20`) VALUES ('".$id."', '".$q[1]."', '".$q[2]."', '".$q[3]."', '".$q[4]."', '".$q[5]."', '".$q[6]."', '".$q[7]."', '".$q[8]."', '".$q[9]."', '".$q[10]."', '".$q[11]."', '".$q[12]."', '".$q[13]."', '".$q[14]."', '".$q[15]."', '".$q[16]."', '".$q[17]."', '".$q[18]."', '".$q[19]."', '".$q[20]."') ON DUPLICATE KEY UPDATE `v1`='".$q[1]."', `v2`='".$q[2]."', `v3`='".$q[3]."', `v4`='".$q[4]."', `v5`='".$q[5]."', `v6`='".$q[6]."', `v7`='".$q[7]."', `v8`='".$q[8]."', `v9`='".$q[9]."', `v10`='".$q[10]."', `v11`='".$q[11]."', `v12`='".$q[12]."', `v13`='".$q[13]."', `v14`='".$q[14]."', `v15`='".$q[15]."', `v16`='".$q[16]."', `v17`='".$q[17]."', `v18`='".$q[18]."', `v19`='".$q[19]."', `v20`='".$q[20]."'";
