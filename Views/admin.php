  ...
  <body class="w3-light-grey">
    ...
    <nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
      <div class="w3-container w3-row">
        ...
        <div class="w3-col s8 w3-bar0">
          ...
          <a href="../Controller/logout.php" class=" w3-button w3-text-red w3-hover-text-red"><i class="fa fa-sign-out"></i></a>
        </div>
      </div>
      <hr>
    ...
    <h5>Dashboard</h5>
      ...
      <div class="w3-bar-block">
        ...
        <a href="?item=10" class="w3-bar-item w3-button w3-padding w3-round-large" id="item_10"><i class="fa fa-file-text-o fa-fw"></i>&nbsp; Offlines</a>
    ...
    <div class="w3-main" style="margin-left:300px;margin-top:43px;">
      ...
      if ($item == "1")
        ...
        require "./admin/offlineLights.php";
        else if ($item == "11")
        require "./admin/onOffLights.php";
        else
        require "./admin/dashboard.php";
      ?>
