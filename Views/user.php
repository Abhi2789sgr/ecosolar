...
.w3-color, .w3-hover-color:hover{color: #fff!important;background-color: #003769!important;}
.w3-text-color, .w3-hover-text-color:hover {color: #003769!important;}
</style>
...
<div class="w3-bar w3-top w3-large w3-card-4 w3-color" style="z-index:4;">
  ...
  <span class="w3-bar-item w3-text-color" style="background-color:#ff9800;height:48px;padding-top:10px;">&#9788; <b><?php echo $project_name; ?></b></span>
...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  <div class="w3-container w3-row">
    ...
    <div class="w3-col s8 w3-bar0">
      ...
      <a href="#" class="w3-bar-item w3-button w3-text-color"></a>
  ...
  <div class="w3-bar-block">
	...
	<?php 
	$id = 0;
	$sql = "SELECT isDefault FROM _a_project where parent=".$branch_value;
	$result = $conn->query($sql);
	if ($result->num_rows > 0)
	$id = $result->fetch_assoc()["isDefault"];
	if($id==0)
    // echo '<a href="?item=5" class="w3-bar-item w3-button w3-padding" id="item_5"><i class="fa fa-cog fa-fw"></i>&nbsp; Settings</a><br><br>';
	?>
  </div>
</nav>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <footer class="w3-container w3-padding-16 w3-light-grey">
    ...
    <p class="w3-right">Powered by <a href="https://ecosi.in/" target="_blank">YellowStar</a></p>
  </footer>
</div>
