...
<div class="w3-container w3-margin-bottom w3-row">
	...
	<button class="w3-button w3-color w3-right w3-margin m8-fancy" id="csvBtn" onclick="downloadCSV()">Download CSV</button>

	<button class="w3-button w3-color w3-right w3-margin m8-fancy" id="pdfBtn" onclick="downloadPDF()">Download PDF</button>
</div>
