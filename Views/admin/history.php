		...
		<div w3-repeat="result" class="w3-quarter w3-mobile" style="padding:5px;">
		  <div class="w3-bar w3-card w3-button m8-fancy">
			<div class="" style="text-align:left!important;" onclick="goHistory('{{Name}}','{{ID}}','{{Branch}}')">
			  <span class="w3-large smallSize" >{{Name}}</span><br>
		...
		<div class="w3-container">
			<div class="w3-card w3-white w3-margin-bottom w3-row m8-fancy">
				<div class="w3-color w3-center w3-padding">
					...
					<div class="w3-row">
						<div class="w3-col s3 m3 l3" style="font-size: 8px;">
			...
			<div class="w3-row">
				...
				<div class="w3-col s6 m4 l4" style="padding:5px;"><button class="w3-button w3-color m8-fancy" style="width:100%;" onclick='window.location.assign("?item=11")'><i class="fa fa-file"></i> ON/OFF logs</button></div>
