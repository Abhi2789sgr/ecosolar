<header class="w3-container w3-text-indigo" style="padding-top:22px">
	<h5><b id="title"><i class="fa fa-table"></i> Offline Lights </b></h5>
</header>
  ...
  <div class="w3-row">
	  ...
	  <div class="w3-threequarter" style="display:none;" id="id03">
		<header class="w3-container w3-text-indigo" style="">
			<h5><b><i class="fa fa-history"></i> <lable id="log_title">Offline Devices</lable> > <lable id="log_name"></lable></b></h5>
		</header>
		<div class="w3-container">
			<div class="w3-card w3-white w3-margin-bottom w3-row m8-fancy">
				<div class="w3-row w3-color w3-center w3-padding m8-fancy">
					...
					<div class="w3-col s6 m3 l3">
						<div id="log_name2" style="word-wrap:break-word;"></div>
					</div>
					<div class="w3-col s6 m3 l3">
			...
			<div class="w3-col s6 m3 l3" style="padding:5px; margin-left:12px;"><button class="w3-button w3-color m8-fancy" style="width:100%;" onclick="deleteofflineDevice()"><i class="fa fa-trash"></i> Delete</button></div>
			<!-- <div class="w3-row">
				<div class="w3-col s6 m3 l3" style="padding:5px;"><button class="w3-button w3-color m8-fancy" style="width:100%;" onclick='window.location.assign("?item=10")'><i class="fa fa-history"></i> Show Logs</button></div>
...
sw();
w3.getHttpObject("../Controller/admin/getOfflineLights.php", myFunction2);
...
function myFunction2(myObject)
{
	...
	alert("Great!!! No Offline Device Found");
	sw();
}
...
function deleteofflineDevice(){
	...
	w3.id("askQuestion").innerHTML = "Are you sure, you want to delete<br><b>" + imei + "?</b></br>";
		w3.id("deleteDeviceButton").innerHTML = '<button class="w3-red w3-button w3-section w3-col s12 m12 l12 m8-fancy" onclick= "deleteSingleDevice(' + imei + ')">Delete</button>';
...
function deleteSingleDevice(selectedImei){
	sw();
        ...
        var url = "../Controller/admin/deleteOffline.php?imei=" + selectedImei;
        const xhttp = new XMLHttpRequest();
        xhttp.onload = function() {
            sw();
...
function deleteAllDevice() {
        ...
        sw();
        var url = "../Controller/admin/deleteOffline.php?imei=all&security_key=" + security_key;
        const xhttp = new XMLHttpRequest();
        xhttp.onload = function() {
            sw();
            var res = this.responseText;
