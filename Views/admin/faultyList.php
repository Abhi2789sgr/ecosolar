		...
		<div class="w3-threequarter" style="display:none;" id="id03">
			<header class="w3-container w3-text-indigo" style="">
				<h5><b><i class="fa fa-history"></i>
						<lable id="log_title">Faulty Device</lable> > <lable id="log_name"></lable>
					</b></h5>
			</header>
				...
				<div class="w3-card w3-white w3-margin-bottom w3-row m8-fancy">
					<div class="w3-row w3-color w3-center w3-padding m8-fancy">
						<div>
							...
							<div class="w3-col s6 m3 l3">
								<div id="log_name2" style="font-size:10px"></div>
							</div>
							<div class="w3-col s6 m3 l3">
						...
						<div>
							<div class="w3-col s6 m3 l3">
								<div><b>Installer Name</b></div>
							</div>
							<div class="w3-col s6 m3 l3">
								<div id="updater_name"></div>
							</div>
							<div class="w3-col s6 m3 l3">
								<div><b>Install Date Time</b></div>
							</div>
							<div class="w3-col s6 m3 l3">
...
<script>
	...
	function get2(url) {
		...
		xhttp.onload = function() {
			...
			w3.id("updater_name").innerHTML = r.updated_by;
			w3.id("install_time").innerHTML = r.installTime;
			...
			try {
				...
				if (r['panel-fault'] == "1" || r['battery-fault'] == "1" || r['luminary-fault'] == "1") {
			...
			try {
				...
				w3.id("fault").innerHTML = r.lastTime;
