...
<center>
	<?php if($page>1) {?>
	<a href="admin.php?item=4&table=0&page=<?php echo max(1, $page - 1); ?>"><button id="prevBtn" class="btn btn-info mx-1 my-1" style="cursor:pointer;">Previous</button></a>
	<?php 
	}
	if($page<$totalPages){
	?>
	<a href="admin.php?item=4&table=0&page=<?php echo ($page + 1); ?>"><button id="nextBtn" class="btn btn-info mx-1 my-1" style="cursor:pointer;">Next</button></a>
<?php } ?>
</center>
