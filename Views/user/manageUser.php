	...
	<ul class="w3-ul" id="id01" style="display:none;">
		<li class="w3-bar m8-fancy w3-card w3-button" w3-repeat="result" onclick="listUser('{{Name}}','{{Branch}}')">
			...
			<div>
				...
				<!-- <button class="m8-fancy w3-color" style="float:right;margin:20px" onclick="editUserDetails('{{id}}','{{uname}}')"><i class="fa fa-edit"></i></button> -->
			</div>
		</li>
	</ul>
...
<div id="deleteUserModal1" class="w3-modal">
    <div class="w3-modal-content w3-animate-top w3-card-4" style="width:400px;height:auto;height:200px;">
        <header class="w3-color">
            <span onclick="document.getElementById('deleteUserModal1').style.display='none'" class="w3-button w3-red w3-display-topright">&times;</span>
            <h2>Delete ?</h2>
        </header>
        <div class="w3-padding">
            ...
            <div class="w3-row" w3-repeat="result" style="margin-top:3vh" id="deleteUserBtn">
        </div>
    </div>
</div>

<div id="editUserModal1" class="w3-modal">
	<div class="w3-modal-content w3-animate-top w3-card-4 w3-white" w3-repeat="result" style="width:73%;height:auto;float:right;margin-right:20px">
		<header class="w3-container w3-color">
			<span onclick="w3.hide('#editUserModal1')" class="w3-button w3-display-topright w3-red">&times;</span>
			<h2>EDIT USER</h2>
		</header>
...
<script>
	...
	function deleteUser(uname) {
		...
		w3.hide('#deleteUserModal1');
		var url = "../Controller/user/deleteUser.php?uname=" + uname + "&security_key=" +security_key;
	...
	function editUserDetails(id, uname) {
		// console.log(id);
		w3.show('#editUserModal1');
		...
		var url = "../Controller/user/editUserVal.php?id=" + id;
		const xhttp = new XMLHttpRequest();
		xhttp.onload = function() {
	...
	function updateUser(id) {
		...
		var url = "../Controller/user/upadateUserVal.php";
