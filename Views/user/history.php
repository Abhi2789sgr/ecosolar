...
<div class="w3-container w3-margin-bottom w3-row">
	...
	<div class="w3-button w3-color w3-right w3-margin m8-fancy" id="exportReport" onclick="exportAdminReport()" style="display:none;">Export Report</div>
			...
			<div class="w3-container">
				<div class="w3-card w3-white w3-margin-bottom w3-row m8-fancy">
					<div class="w3-color w3-center w3-padding">
						...
						<div class="w3-row ">
							<div class="w3-col s4 m4 l4" style="word-wrap: break-word;">
								<div id="panel_qr">--</div>
							</div>
							<div class="w3-col s4 m4 l4" style="word-wrap: break-word;">
						...
						<div class="w3-row w3-color w3-center w3-padding m8-fancy">
							<div class="w3-col s6 m3 l3" style="word-wrap: break-word;">
								<div><b>Remark</b></div>
							</div>
...
<script>
	...
	function exportAdminReport() {
		...
		// }
		if (heading == "BLOCK LIST") {
			url = '../Controller/user/exportRecord.php?district_id=' + district_id;
		}
		if (heading == "PANCHAYAT LIST") {
			url = '../Controller/user/exportRecord.php?district_id=' + district_id + '&block_id=' + block_id;
		}
		if (heading == "WARD LIST") {
			url = '../Controller/user/exportRecord.php?district_id=' + district_id + '&block_id=' + block_id + '&panchayat_id=' + panchayat_id;
		}
		if (heading == "DEVICE LIST") {
			url = '../Controller/user/exportRecord.php?district_id=' + district_id + '&block_id=' + block_id + '&panchayat_id=' + panchayat_id + '&ward_id=' + ward_id;
		}
