...
<div class="w3-row w3-container">
  ...
  <div class="w3-half w3-padding">
	<div class="w3-container w3-white w3-card m8-fancy">
		...
		<form action="../Controller/user/upload.php" method="post" enctype="multipart/form-data" class="w3-section" onsubmit="event.preventDefault(); submitForm(this); return false;">
...
<script>
w3.getHttpObject("../Controller/user/getRate.php", function(text){
...
function urate()
{
	...
	ajax("../Controller/user/updateRate.php",param);
}
